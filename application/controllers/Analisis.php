...
class Analisis extends CI_Controller {
	...
	function ajax_save()
	{
        ...
        {	
			...
			{	
				...
				$data = array('id_analisis' => $analisis['id_analisis'],
							  'id_permohonan' => $this->input->post('id_permohonan'),	
	...
	function get_detail_analisis($id_permohonan)
	{
		if($this->session->userdata('logged_in'))
        {
			...
			echo json_encode(array($analisis, $permohonan, $issue_ham, $kabkota));
		}
		else
		{
			echo json_encode(array('success' => FALSE));
	...
	function ajax_update()
	{
		if($this->session->userdata('logged_in'))
        {
			...
			$data = array('id_analisis' => $this->input->post('id_analisis'),
	...
	function view_detail_analisis($id_permohonan)
	{
		if($this->session->userdata('logged_in'))
        {
			...
			echo json_encode(array($analisis, $issue_ham));
		}
		else
		{
			echo json_encode(array('success' => FALSE));
