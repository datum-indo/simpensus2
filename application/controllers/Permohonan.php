...
class Permohonan extends CI_Controller {
	...
	function ajax_upload_kid()
	{
		...
		for ($i = 0; $i < $file_doc_kid; $i++)
		{
			...
			{
				$file_uploaded = array('link'=> '<li class="list-group-item list-group-item-danger">'.$_FILES['doc_kid']['name'].'</a><a id="error'.$i.'" class="delete" href="javascript:void(0)" style="float: right;" title="Delete" status="0"><span class="glyphicon glyphicon-remove"></span></a></li>',
									   'filename' => $_FILES['doc_kid']['name'],
	...
	function ajax_upload_ktm()
	{
		...
		for ($i = 0; $i < $file_doc_ktm; $i++)
		{
			...
			{
				$file_uploaded = array('link'=> '<li class="list-group-item list-group-item-danger">'.$_FILES['doc_ktm']['name'].'</a><a id="error'.$i.'" class="delete" href="javascript:void(0)" style="float: right;" title="Delete" status="0"><span class="glyphicon glyphicon-remove"></span></a></li>',
									   'filename' => $_FILES['doc_ktm']['name'],
									   'fileuploaded' => 'Unknown file extension',		
									   'status' => FALSE
				);
		...
		if($this->session->userdata('logged_in'))
        {
			...
			else
			{
				...
				{	
					...
					$data_permohonan = array('id_permohonan' => $register['id_permohonan'],
					...
					$data_pemohon = array('id_permohonan' => $register['id_permohonan'],
										  'insert_date' => date('Y-m-d H:i:s'),
										  'insert_by' => $this->data['id_user'],
										  'update_date' => '0000-00-00 00:00:00',
										  'update_by' => '0',
					...
					if($this->input->post('status_pemohon') == 'Ya')
					{
						...
						$data_penerima = array('id_permohonan' => $register['id_permohonan'],
											  'insert_date' => date('Y-m-d H:i:s'),
											  'insert_by' => $this->data['id_user'],
											  'update_date' => '0000-00-00 00:00:00',
											  'update_by' => '0',
	...
	function get_detail_permohonan($id_permohonan)
	{
		if($this->session->userdata('logged_in'))
        {
			...
			if ($filekid->num_rows() > 0)
			{
				...
				{
					$detail_kid[] = array('link' => '<li class="list-group-item list-group-item-success"><a href="javascript:void(0)" onclick="view_file('."'".$row->id_file."'".')" title="Download">'.$row->nm_baru.'</a><a id="'.$row->id_file.'" class="delete" href="javascript:void(0)" style="float: right;" title="Delete" status="1"><span class="glyphicon glyphicon-remove"></span></a></li>',	
										   'id_file' => $row->id_file,
			...
			if ($filektm->num_rows() > 0)
			{
				...
				{
					$detail_ktm[] = array('link' => '<li class="list-group-item list-group-item-success"><a href="javascript:void(0)" onclick="view_file('."'".$row->id_file."'".')" title="Download">'.$row->nm_baru.'</a><a id="'.$row->id_file.'" class="delete" href="javascript:void(0)" style="float: right;" title="Delete" status="1"><span class="glyphicon glyphicon-remove"></span></a></li>',	
										   'id_file' => $row->id_file,
										   'fileuploaded' => $row->nm_file,
										   'filename' => $row->nm_asli,
										   'nm_baru' => $row->nm_baru,
	...
	function ajax_update()
	{
		if($this->session->userdata('logged_in'))
        {
			...
			else
			{
				...
				$data_permohonan = array('update_date' => date('Y-m-d H:i:s'),
				...
				$data_pemohon = array('update_date' => date('Y-m-d H:i:s'),
									  'update_by' => $this->data['id_user'],
									  'nm_lengkap' => $this->input->post('nm_lengkap'),
									  'nm_panggilan' => $this->input->post('nm_panggilan'),
									  'tmp_lahir' => $this->input->post('tmp_lahir'),
				...
				if($this->input->post('status_pemohon') == 'Ya')
				{
					...
					$data_penerima = array('update_date' => date('Y-m-d H:i:s'),
										  'update_by' => $this->data['id_user'],
										  'nm_lengkap' => $this->input->post('nm_lengkap'),
										  'nm_panggilan' => $this->input->post('nm_panggilan'),
										  'tmp_lahir' => $this->input->post('tmp_lahir'),
	...
	function view_detail_permohonan($id_permohonan)
	{
		if($this->session->userdata('logged_in'))
        {
			...
			if ($filekid->num_rows() > 0)
			{
				foreach ($filekid->result() as $row)
				{
					$detail_kid[] = array('link' => '<li class="list-group-item">'.$row->nm_baru.'<a href="javascript:void(0)" onclick="view_file('."'".$row->id_file."'".')" style="float: right;" title="Download"><span class="glyphicon glyphicon-save"></span></a></li>',	
										  'id_file' => $row->id_file,
										  'fileuploaded' => $row->nm_file,
										  'filename' => $row->nm_asli,
										  'nm_baru' => $row->nm_baru,
			...
			if ($filektm->num_rows() > 0)
			{
				foreach ($filektm->result() as $row)
				{
					$detail_ktm[] = array('link' => '<li class="list-group-item">'.$row->nm_baru.'<a href="javascript:void(0)" onclick="view_file('."'".$row->id_file."'".')" style="float: right;" title="Download"><span class="glyphicon glyphicon-save"></span></a></li>',	
										  'id_file' => $row->id_file,
										  'fileuploaded' => $row->nm_file,
										  'filename' => $row->nm_asli,
										  'nm_baru' => $row->nm_baru,
	...
	function ajax_upload_kidx()
	{
		...
		for ($i = 0; $i < $file_doc_kid; $i++)
		{
			...
			{
				$file_uploaded = array('link'=> '<li class="list-group-item list-group-item-danger">'.$_FILES['doc_kidx']['name'].'</a><a id="error'.$i.'" class="delete" href="javascript:void(0)" style="float: right;" title="Delete" status="0"><span class="glyphicon glyphicon-remove"></span></a></li>',
									   'filename' => $_FILES['doc_kidx']['name'],
									   'fileuploaded' => 'Unknown file extension',		
									   'status' => FALSE
				);
	...
	function ajax_upload_ktmx()
	{
		...
		for ($i = 0; $i < $file_doc_ktm; $i++)
		{
			...
			{
				$file_uploaded = array('link'=> '<li class="list-group-item list-group-item-danger">'.$_FILES['doc_ktmx']['name'].'</a><a id="error'.$i.'" class="delete" href="javascript:void(0)" style="float: right;" title="Delete" status="0"><span class="glyphicon glyphicon-remove"></span></a></li>',
									   'filename' => $_FILES['doc_ktmx']['name'],
									   'fileuploaded' => 'Unknown file extension',		
									   'status' => FALSE
				);
	...
	function _validate1b()
	{
		...
		if($this->input->post('id_agamab') == '7')
		{
