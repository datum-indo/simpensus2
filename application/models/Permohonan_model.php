...
class Permohonan_model extends CI_Model {
	...
	function view_detail_permohonan($id_permohonan)
	{
		$permohonan = $this->db->query("SELECT tbl_permohonan.no_reg, DATE_FORMAT(tbl_permohonan.insert_date, '%d/%m/%Y') AS tgl_reg, 
										tbl_pemohon.nm_lengkap AS nm_pemohon, tbl_pemohon.nm_panggilan, tbl_pemohon.tmp_lahir, DATE_FORMAT(tbl_pemohon.tgl_lahir, '%d') AS tgl_lahir, DATE_FORMAT(tbl_pemohon.tgl_lahir, '%m') AS bln_lahir, DATE_FORMAT(tbl_pemohon.tgl_lahir, '%Y') AS thn_lahir,
										tbl_pemohon.umur, tbl_pemohon.jkel, tbl_golongan_darah.golongan_darah, tbl_pemohon.kondisi_fisik, tbl_pemohon.id_difabel, tbl_difabel.jenis_difabel, tbl_pemohon.status_perkawinan, tbl_pendidikan.nm_pendidikan,
										tbl_pemohon.id_agama, tbl_agama.nm_agama, tbl_pemohon.agama_desc, tbl_pemohon.kewarganegaraan, tbl_pemohon.id_negara, tbl_negara.nm_negara, tbl_pemohon.id_pekerjaan, tbl_pekerjaan.jenis_pekerjaan, tbl_pemohon.pekerjaan_desc, 
										tbl_pemohon.pekerjaan2, tbl_pemohon.pekerjaan2_desc, tbl_pemohon.pekerjaansi, tbl_pemohon.id_pekerjaansi, tbl_pekerjaansi.jenis_pekerjaan AS jenis_pekerjaansi, tbl_pemohon.pekerjaansi_desc, tbl_penghasilan.jml_penghasilan, tbl_pemohon.jml_anak, tbl_pemohon.tanggungan_total,
										...
										tbl_penerima.umur AS umurb, tbl_penerima.jkel AS jkelb, tbl_golongan_darahb.golongan_darah AS golongan_darahb, tbl_penerima.kondisi_fisik AS kondisi_fisikb, tbl_penerima.id_difabel AS id_difabelb, tbl_difabelb.jenis_difabel AS jenis_difabelb, tbl_penerima.status_perkawinan AS status_perkawinanb,
										tbl_pendidikanb.nm_pendidikan AS nm_pendidikanb, tbl_penerima.id_agama AS id_agamab, tbl_agamab.nm_agama AS nm_agamab, tbl_penerima.agama_desc AS agama_descb, tbl_penerima.kewarganegaraan AS kewarganegaraanb, tbl_penerima.id_negara AS id_negarab,
										tbl_negarab.nm_negara AS nm_negarab, tbl_penerima.id_pekerjaan AS id_pekerjaanb, tbl_pekerjaanb.jenis_pekerjaan AS jenis_pekerjaanb, tbl_penerima.pekerjaan_desc AS pekerjaan_descb, tbl_penerima.pekerjaan2 AS pekerjaan2b, tbl_penerima.pekerjaan2_desc AS pekerjaan2_descb,
										tbl_penerima.pekerjaansi AS pekerjaansib, tbl_penerima.id_pekerjaansi AS id_pekerjaansib, tbl_pekerjaansib.jenis_pekerjaan AS jenis_pekerjaansib, tbl_penerima.pekerjaansi_desc AS pekerjaansi_descb, tbl_penghasilanb.jml_penghasilan AS jml_penghasilanb, tbl_penerima.jml_anak AS jml_anakb,
										...
										LEFT JOIN tbl_pekerjaan AS tbl_pekerjaansi ON tbl_pemohon.id_pekerjaansi = tbl_pekerjaansi.id_pekerjaan
										...
										LEFT JOIN tbl_pekerjaan AS tbl_pekerjaansib ON tbl_penerima.id_pekerjaansi = tbl_pekerjaansib.id_pekerjaan
