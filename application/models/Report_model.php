...
class Report_model extends CI_Model {
	...
	function get_extract_all_data($periode, $tahun)
	{
		...
		if($periode == 'Semua')
		{
			$query = $this->db->query	("SELECT 'nomor_permohonan', 'tgl_permohonan', 'provinsi', 'kab_kota', 'umur', 'kategori_umur', 'jenis_kelamin', 'kelainan_fisik', 'jenis_kelainan', 'status_perkawinan', 'pendidikan', 'agama', 'agama_lain', 
										...
										WHEN 'Cerai Mati' AND tbl_penerima.jkel = 'Lain-lain' THEN 'Janda/Duda'
										WHEN 'Cerai Hidup' AND tbl_penerima.jkel = 'Lain-lain' THEN 'Janda/Duda'
										ELSE 'N/A'
	...
	function get_frequency_result($freq_type, $freq_periode, $freq_tahun)
	{
		if($freq_periode == 'Semua')
		{
			...
			else if($freq_type == '2') /*Jkel*/
			{
				...
				$query = $this->db->query("SELECT IF(jkel = 'Lain-lain', 'Lain-lain', jkel) AS description, 
										   jumlah, 
