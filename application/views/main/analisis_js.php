...
$(document).ready(function() {
	...
	$('[name="id_permohonan"]').change(function ()
	{
		...
		if(id_permohonan != "")
		{
			...
			$('[name="tgl_kejadian"]').prop({disabled: false});
			...
			$('[name="lk_dewasa"]').val('');
			$('[name="lk_dewasa"]').prop({disabled: false});
								
			$('[name="pr_dewasa"]').val('');
			$('[name="pr_dewasa"]').prop({disabled: false});
					
			$('[name="lk_anak"]').val('');
			$('[name="lk_anak"]').prop({disabled: false});
					
			$('[name="pr_anak"]').val('');
			$('[name="pr_anak"]').prop({disabled: false});
					
			$('[name="total_penerima"]').val('0');
										
			$('[name="uu_lbh"]').val('');
			$('[name="uu_lbh"]').prop({disabled: false});
					
			$('[name="uu_lawan"]').val('');
			$('[name="uu_lawan"]').prop({disabled: false});
					
			$('[name="keterangan"]').val('');
			$('[name="keterangan"]').prop({disabled: false});
		...
		else
		{
			...
			$('[name="tgl_kejadian"]').val('');
			$('[name="tgl_kejadian"]').prop({disabled: true});
			...
			$('[name="lk_dewasa"]').val('');
			$('[name="lk_dewasa"]').prop({disabled: true});
						
			$('[name="pr_dewasa"]').val('');
			$('[name="pr_dewasa"]').prop({disabled: true});
			
			$('[name="lk_anak"]').val('');
			$('[name="lk_anak"]').prop({disabled: true});
			
			$('[name="pr_anak"]').val('');
			$('[name="pr_anak"]').prop({disabled: true});
			
			$('[name="total_penerima"]').val('0');
			
			$('[name="uu_lbh"]').val('');
			$('[name="uu_lbh"]').prop({disabled: true});
			
			$('[name="uu_lawan"]').val('');
			$('[name="uu_lawan"]').prop({disabled: true});
	...
	$('[name="bentuk_kasus"]').change(function ()
	{
		...
		{
			$('[name="id_penghasilan"]').prop({disabled: false});
...
function add()
{
	...
	$.ajax({
        ...
        success: function(response)
        {
			...
			$('#form-analisis').modal({backdrop: 'static', keyboard: false})  
