						...
						<div class="">
							<div class="col-lg-6">
								<div class="form-group">
									...
									<?php echo form_dropdown('id_pekerjaan', $pekerjaan, '', 'id="id_pekerjaan" class="form-control chosen-select-deselect" data-placeholder="Pekerjaan Pokok"'); ?>
									<span class="help-block"></span>
								</div>
								...
								<div class="form-group" id="pekerjaansi_info">
									...
									<?php echo form_dropdown('id_pekerjaansi', $pekerjaan, '', 'id="id_pekerjaansi" class="form-control chosen-select-deselect" data-placeholder="Pekerjaan Suami/Istri"'); ?>
									<span class="help-block"></span>
								</div>
							...
							<div class="col-lg-6">
								...
								<fieldset class="group1">
									...
									<div id="" class="form-group">
										...
										<div id="harta" class="col-md-8">
											<?php// echo form_input('harta_lain', '', 'id="harta_lain" placeholder="" class="form-control numeric"'); ?>
											<span class="help-block"></span>
										</div>
									</div>
									-->
					...
					<div class="row" data-step="2b" data-title="Callback on second step" id="step-2b">
						<div class="">
							<div class="col-lg-6">
								<div class="form-group">
									<label class="control-label">Pekerjaan Pokok</label>
									<?php echo form_dropdown('id_pekerjaanb', $pekerjaan, '', 'id="id_pekerjaanb" class="form-control chosen-select-deselect" data-placeholder="Pekerjaan Pokok"'); ?>
									<span class="help-block"></span>
								</div>
								<div id="pekerjaan_desc_info" class="form-group">
									<label class="control-label">Lainnya</label>
								...
								<div class="form-group" id="pekerjaansi_info">
									<label class="control-label">Pekerjaan Istri/Suami</label>
									<?php echo form_dropdown('id_pekerjaansib', $pekerjaan, '', 'id="id_pekerjaansib" class="form-control chosen-select-deselect" data-placeholder="Pekerjaan Suami/Istri"'); ?>
									<span class="help-block"></span>
								</div>
								<div class="form-group" id="pekerjaansi_desc_info">
									<label class="control-label">Lainnya</label>
