...
$(document).ready(function() {
	...
	$('input[name="jkel"][value="Lain-lain"]').removeAttr('checked');
	...
	$('input[name="jkel"]').change(function ()
	{
		...
		else 
		{
			...
			$('input[name="jkel"][value="Laki-laki"]').removeAttr('checked');
			$('input[name="jkel"][value="Perempuan"]').removeAttr('checked');
			$('input[name="jkel"][value="Lain-lain"]').attr('checked', 'checked');
		}	
	});
	...
	var _id_kecamatan = $('select[name="id_kecamatan"]');
	var _id_desa = $('select[name="id_desa"]');
	
	_id_kabkota.children().remove().end();
	_id_kabkota.prop({disabled: true});
	_id_kabkota.trigger('chosen:updated');
	
	_id_kecamatan.children().remove().end();
	_id_kecamatan.prop({disabled: true});
	_id_kecamatan.trigger('chosen:updated');
		
	_id_desa.children().remove().end();
	_id_desa.prop({disabled: true});
	_id_desa.trigger('chosen:updated');
	...
	$('#id_provinsi').change(function ()
	{
		...
		if(id_provinsi != "")
		{
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('permohonan/get_kabkota'); ?>/" + id_provinsi,
	...
	$('#id_kabkota').change(function ()
	{
		...
		if(id_kabkota != "")
		{
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('permohonan/get_kecamatan'); ?>/" + id_kabkota,
				success: function(kecamatan) 
				{
					$('#id_kecamatan').empty();
					_id_kecamatan.append('<option value=""></option>');
					$.each(kecamatan, function(id_kecamatan, nm_kecamatan) {
						var opt = $('<option />'); 
						opt.val(id_kecamatan);
						opt.text(nm_kecamatan);
						$('#id_kecamatan').append(opt); 
					});
					_id_kecamatan.prop({disabled: false});
					$('#id_kecamatan').trigger('chosen:updated');
	...
	$('#id_kecamatan').change(function ()
	{
		...
		if(id_kecamatan != "")
		{
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('permohonan/get_desa'); ?>/" + id_kecamatan,
				success: function(desa) 
				{
					$('#id_desa').empty();
					_id_desa.append('<option value=""></option>');
					$.each(desa, function(id_desa, nm_desa) {
						var opt = $('<option />'); 
						opt.val(id_desa);
						opt.text(nm_desa);
						$('#id_desa').append(opt); 
					});
					_id_desa.prop({disabled: false});
					$('#id_desa').trigger('chosen:updated');
				}	 
			});	
		}	
	...
	$('input[name="jkelb"][value="Lain-lain"]').removeAttr('checked');
	...
	$('input[name="jkelb"]').change(function ()
	{
		...
		else 
		{
			...
			$('input[name="jkelb"][value="Laki-laki"]').removeAttr('checked');
			$('input[name="jkelb"][value="Perempuan"]').removeAttr('checked');
			$('input[name="jkelb"][value="Lain-lain"]').attr('checked', 'checked');
		}	
	});
	...
	var _id_kecamatanb = $('select[name="id_kecamatanb"]');
	var _id_desab = $('select[name="id_desab"]');
	
	_id_kabkotab.children().remove().end();
	_id_kabkotab.prop({disabled: true});
	_id_kabkotab.trigger('chosen:updated');
	
	_id_kecamatanb.children().remove().end();
	_id_kecamatanb.prop({disabled: true});
	_id_kecamatanb.trigger('chosen:updated');
		
	_id_desab.children().remove().end();
	_id_desab.prop({disabled: true});
	_id_desab.trigger('chosen:updated');
	...
	$('#id_provinsib').change(function ()
	{
		...
		if(id_provinsib != "")
		{
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('permohonan/get_kabkota'); ?>/" + id_provinsib,
				success: function(kabkota) 
				{
					$('#id_kabkotab').empty();
	...
	$('#id_kabkotab').change(function ()
	{
		var id_kabkotab = $('#id_kabkotab').val();
		if(id_kabkotab != "")
		{
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('permohonan/get_kecamatan'); ?>/" + id_kabkotab,
				success: function(kecamatan) 
				{
					$('#id_kecamatanb').empty();
					_id_kecamatanb.append('<option value=""></option>');
					$.each(kecamatan, function(id_kecamatanb, nm_kecamatan) {
						var opt = $('<option />'); 
						opt.val(id_kecamatanb);
						opt.text(nm_kecamatan);
						$('#id_kecamatanb').append(opt); 
					});
					_id_kecamatanb.prop({disabled: false});
					$('#id_kecamatanb').trigger('chosen:updated');
	...
	$('#id_kecamatanb').change(function ()
	{
		var id_kecamatanb = $('#id_kecamatanb').val();
		if(id_kecamatanb != "")
		{
			$.ajax({
				type: "POST",
				url: "<?php echo site_url('permohonan/get_desa'); ?>/" + id_kecamatanb,
				success: function(desa) 
				{
					$('#id_desab').empty();
					_id_desab.append('<option value=""></option>');
					$.each(desa, function(id_desab, nm_desa) {
						var opt = $('<option />'); 
						opt.val(id_desab);
						opt.text(nm_desa);
						$('#id_desab').append(opt); 
					});
					_id_desab.prop({disabled: false});
					$('#id_desab').trigger('chosen:updated');
				}	 
			});	
		}	
	...
	$('#doc_kid').change(function(e)
	{
		...
		$.ajax({
			url: "<?php echo site_url('permohonan/ajax_upload_kid/')?>/",
			type: "POST",
			data: ajaxData,
			dataType: "JSON",
			cache: false,
	...
	$('#list_kid').on('click', 'a.delete', function() {
		...
		else
		{
			if(confirm('Are you sure delete this file?'))
			{
				...
				$.ajax({
					url : "<?php echo site_url('permohonan/ajax_delete_attachment')?>/",
					type: "POST",
					dataType: "JSON",
					data: formData,
	...
	$('#doc_ktm').change(function(e)
	{
		...
		$.ajax({
			url: "<?php echo site_url('permohonan/ajax_upload_ktm/')?>/",
			type: "POST",
			data: ajaxData,
			dataType: "JSON",
			cache: false,
	...
	$('#doc_kidx').change(function(e)
	{
		...
		$.ajax({
			url: "<?php echo site_url('permohonan/ajax_upload_kidx/')?>/",
			type: "POST",
			data: ajaxData,
			dataType: "JSON",
			cache: false,
	...
	$('#doc_ktmx').change(function(e)
	{
		...
		$.ajax({
			url: "<?php echo site_url('permohonan/ajax_upload_ktmx/')?>/",
			type: "POST",
			data: ajaxData,
			dataType: "JSON",
			cache: false,
	...
	$('#lampiran').change(function(e)
	{
		...
		*/
		...
		$.ajax({
			url: "<?php echo site_url('permohonan/ajax_upload_permohonan/')?>/",
			type: "POST",
			data: ajaxData,
			dataType: "JSON",
			cache: false,
...
function add()
{
	...
	$.ajax({
        url : "<?php echo site_url('permohonan/ajax_new/')?>/",
        type: "GET",
        dataType: "JSON",
		data: formData,
        success: function(response)
...
function next1()
{
	...
	if(save_method == 'add') 
	{
        url = "<?php echo site_url('permohonan/ajax_save'); ?>";
    } 
	else 
	{
...
function edit(id_permohonan)
{
	...
	$.ajax({
        url : "<?php echo site_url('permohonan/get_detail_permohonan')?>/" + id_permohonan,
        type: "GET",
        dataType: "JSON",
        success: function(response)
        {
			...
			*/
			...
			if(status_pemohon == 'Tidak')
			{
				...
				var kecamatanb = response[7];
				var _id_kecamatanb = $('select[name="id_kecamatanb"]');
				$('#id_kecamatanb').empty();
				_id_kecamatanb.append('<option value=""></option>');
				$.each(kecamatanb, function(id_kecamatanb, nm_kecamatanb) {
					var opt = $('<option />'); 
					opt.val(id_kecamatanb);
					opt.text(nm_kecamatanb);
					$('#id_kecamatanb').append(opt); 
				});
				_id_kecamatanb.prop({disabled: false});
				$('#id_kecamatanb').trigger('chosen:updated');
				...
				var desab = response[8];
				var _id_desab = $('select[name="id_desab"]');	
				$('#id_desab').empty();
				_id_desab.append('<option value=""></option>');
				$.each(desab, function(id_desab, nm_desab) {
					var opt = $('<option />'); 
					opt.val(id_desab);
					opt.text(nm_desab);
					$('#id_desab').append(opt); 
...
function edit_kronologi(id_permohonan)
{
	...
	$.ajax({
        url : "<?php echo site_url('permohonan/get_kronologi')?>/" + id_permohonan,
        type: "GET",
        dataType: "JSON",
        success: function(response)
        {
...
function update_kronologi()
{
	...
	$.ajax({
		url : "<?php echo site_url('permohonan/ajax_update_kronologi')?>",
		type: "POST",
		data: formData, //$('#formPemohon').serialize(),
		dataType: "JSON",
		success: function(data)
...
function view(id_permohonan)
{
	...
	$.ajax({
        url : "<?php echo site_url('permohonan/view_detail_permohonan')?>/" + id_permohonan,
        type: "GET",
        dataType: "JSON",
        success: function(response)
        {
			...
			*/
			...
			$('#dd_nm_kecamatan').append(permohonan.nm_kecamatan);
			$('#dd_nm_desa').append(permohonan.nm_desa);
			...
			*/
			...
			if(vstatus_pemohon == 'Tidak')
			{
				...
				*/
				...
				$('#dd_nm_kecamatanb').append(permohonan.nm_kecamatanb);
				$('#dd_nm_desab').append(permohonan.nm_desab);
...
{
	//alert(id_file);	
	url = "<?php echo site_url('permohonan/get_file_attachment')?>/"+id_file;
	window.open(url);
}
...
function del(id_permohonan)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('permohonan/ajax_delete')?>",
            type: "POST",
			data: formData,
            dataType: "JSON",
            success: function(data)
...
function up(id_permohonan)
{
	...
	$.ajax({
		url : "<?php echo site_url('permohonan/get_file_permohonan')?>/" + id_permohonan,
        type: "GET",
        dataType: "JSON",
        success: function(response)
        {
			...
			var dokumen_status = response[3];
			$('[name="status_dokumen"]').val(dokumen_status.status_dokumen).trigger("chosen:updated");
...
function save_upload()
{
	...
	var formData = {
		...
		status_dokumen: $('[name="status_dokumen"]').val()
	};
	
	url = "<?php echo site_url('permohonan/ajax_save_file_permohonan'); ?>";
...
{
	url = "<?php echo site_url('permohonan/get_output_formulir_permohonan')?>/"+id_permohonan;
	window.open(url);
}

function pdf_bukti(id_permohonan)
{
	url = "<?php echo site_url('permohonan/get_output_bukti_permohonan')?>/"+id_permohonan;
	window.open(url);
}
